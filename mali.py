...
app.layout = html.Div([
        ...
        dbc.Row([
            ...
            dbc.Col(html.H1('Inventaire Du Stock Mali',
                            style={
                                'textAlign': 'center',
                                'color': 'white'
                                }),
                width={'size': 4, 'offset': 3}, ),
            dbc.Col(id ='refresh' ,children=html.P('Last update  :  ' f'{date.today()}',
                           style={
                                   'textAlign': 'right',
                                   'color': 'orange',
                                   'fontSize': 16}),
...
if __name__ == '__main__':
    app.run_server(debug=True,dev_tools_ui=False, host='0.0.0.0', port=8082)
