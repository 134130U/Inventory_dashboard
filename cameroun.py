...
tl = telechargement('cameroun')

UPLOAD_DIRECTORY = "history/cameroun/app_uploaded_files"
...
app.layout = html.Div([
        ...
        dbc.Row([
            ...
            dbc.Col(html.H1('Inventaire Du Stock Cameroun',
                            style={
                                'textAlign': 'center',
                                'color': 'white'
                                }),
...
if __name__ == '__main__':
    app.run_server(debug=True,dev_tools_ui=False, host='0.0.0.0', port=8086)
